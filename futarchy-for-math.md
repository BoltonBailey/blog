...
Previously, [I wrote](https://thequantummilkman.substack.com/p/speculations-on-adoption-of-theorem) about [Vadim's work](https://ratandtiger.substack.com/p/a-theorem-marketplace-awaits-your) towards a [decentralized marketplace for formal theorems](https://theorem-marketplace.com/). Now, he's [announced](https://ratandtiger.substack.com/p/theorem-marketplace-source-code) that the code for this site [has been made open-source](https://github.com/wadimiusz/theorem-marketplace). Hooray!
...
1. We start with the theorem to be proved by year XXXX. (For example ["Fermat's Last Theorem will be formally proved by 2029"](https://manifold.markets/BoltonBailey/will-we-have-a-formalized-proof-of))
